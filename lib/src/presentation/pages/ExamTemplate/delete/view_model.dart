...
import '/src/domain/operation/mutations/deleteExamTemplate/deleteexamtemplate_mutation.dart';
...
class ViewModel extends ChangeNotifier {
  ...
  /// Elimina una plantilla de examen por ID
  ...
  Future<bool> delete({required String id}) async {
    ...
    try {
      ...
      _errorService.showError(
        message: l10n.femeThingDeletedSuccessfully(l10n.examTemplate),
        type: ErrorType.success,
      );

      debugPrint('✅ ExamTemplate eliminado exitosamente');
    } catch (e, stackTrace) {
      debugPrint('💥 Error al eliminar ExamTemplate: $e');
      debugPrint('📍 StackTrace: $stackTrace');

      success = false;

      // Manejo de errores específicos
      String errorMessage = l10n.errorDeleting(l10n.examTemplate);
