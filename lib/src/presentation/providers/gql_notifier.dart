...
class GQLNotifier extends ChangeNotifier {
  ...
  GQLNotifier({required this.authNotifier, required this.errorService}) {
    Map<String, ErrorHandler> errorHandlers = {
      ...
      '071': handleGenericError,
      '072': handleGenericError,
      '073': handleGenericError,
      '074': handleGenericError,
      '075': handleGenericError,
      '076': handleGenericError,
      '077': handleGenericError,
      '078': handleGenericError,
      '079': handleGenericError,
      '080': handleGenericError,
      '081': handleGenericError,
      '082': handleGenericError,
      '083': handleGenericError,
      '084': handleGenericError,
      '085': handleGenericError,
      '086': handleGenericError,
      '087': handleGenericError,
      '088': handleGenericError,
      '089': handleGenericError,
      '090': handleGenericError,
    };
