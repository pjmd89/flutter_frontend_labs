...
class CreatePatientMutation implements Operation{
  final PatientFieldsBuilder builder;
  final String _name = 'createPatient';
  ...
  @override
  get name => _name;
  CreatePatientMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
