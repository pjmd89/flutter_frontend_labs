...
class CreateExamMutation implements Operation{
  final ExamFieldsBuilder builder;
  final String _name = 'createExam';
  ...
  @override
  get name => _name;
  CreateExamMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
