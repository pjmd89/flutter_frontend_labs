...
class UpdateExamTemplateMutation implements Operation{
  final ExamTemplateFieldsBuilder builder;
  final String _name = 'updateExamTemplate';
  ...
  @override
  get name => _name;
  UpdateExamTemplateMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  ExamTemplate result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return ExamTemplate.fromJson(data[name]);
  }
