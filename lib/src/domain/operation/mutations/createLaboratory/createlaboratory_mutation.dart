...
class CreateLaboratoryMutation implements Operation{
  final LaboratoryFieldsBuilder builder;
  final String _name = 'createLaboratory';
  ...
  @override
  get name => _name;
  CreateLaboratoryMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
