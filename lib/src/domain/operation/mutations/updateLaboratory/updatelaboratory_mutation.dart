...
class UpdateLaboratoryMutation implements Operation{
  final LaboratoryFieldsBuilder builder;
  final String _name = 'updateLaboratory';
  ...
  @override
  get name => _name;
  UpdateLaboratoryMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
