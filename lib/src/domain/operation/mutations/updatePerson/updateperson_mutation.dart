...
class UpdatePersonMutation implements Operation{
  final PersonFieldsBuilder builder;
  final String _name = 'updatePerson';
  ...
  @override
  get name => _name;
  UpdatePersonMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
