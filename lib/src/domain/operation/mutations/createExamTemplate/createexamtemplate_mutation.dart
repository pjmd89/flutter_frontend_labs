...
class CreateExamTemplateMutation implements Operation{
  final ExamTemplateFieldsBuilder builder;
  final String _name = 'createExamTemplate';
  ...
  @override
  get name => _name;
  CreateExamTemplateMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
