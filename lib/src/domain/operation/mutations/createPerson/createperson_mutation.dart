...
class CreatePersonMutation implements Operation{
  final PersonFieldsBuilder builder;
  final String _name = 'createPerson';
  ...
  @override
  get name => _name;
  CreatePersonMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  Person result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return Person.fromJson(data[name]);
  }
