...
class UpdateUserMutation implements Operation{
  final UserFieldsBuilder builder;
  final String _name = 'updateUser';
  ...
  @override
  get name => _name;
  UpdateUserMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
