...
class CreateInvoiceMutation implements Operation{
  final InvoiceFieldsBuilder builder;
  final String _name = 'createInvoice';
  ...
  @override
  get name => _name;
  CreateInvoiceMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
