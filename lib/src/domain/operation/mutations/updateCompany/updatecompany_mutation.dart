...
class UpdateCompanyMutation implements Operation{
  final CompanyFieldsBuilder builder;
  final String _name = 'updateCompany';
  ...
  @override
  get name => _name;
  UpdateCompanyMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  Company result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return Company.fromJson(data[name]);
  }
