...
class DeletePatientMutation implements Operation{
  final PatientFieldsBuilder builder;
  final String _name = 'deletePatient';
  ...
  @override
  get name => _name;
  DeletePatientMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
