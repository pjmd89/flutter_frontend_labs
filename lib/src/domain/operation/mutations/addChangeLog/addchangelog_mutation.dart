...
class AddChangeLogMutation implements Operation{
  final ChangeLogFieldsBuilder builder;
  final String _name = 'addChangeLog';
  ...
  @override
  get name => _name;
  AddChangeLogMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  ChangeLog result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return ChangeLog.fromJson(data[name]);
  }
