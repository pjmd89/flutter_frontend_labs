...
class DeleteExamTemplateMutation implements Operation{
  final ExamTemplateFieldsBuilder builder;
  final String _name = 'deleteExamTemplate';
  ...
  @override
  get name => _name;
  DeleteExamTemplateMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
