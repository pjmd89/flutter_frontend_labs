...
class UpdatePatientMutation implements Operation{
  final PatientFieldsBuilder builder;
  final String _name = 'updatePatient';
  ...
  @override
  get name => _name;
  UpdatePatientMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  Patient result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
