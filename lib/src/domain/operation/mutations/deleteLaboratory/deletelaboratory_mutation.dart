...
class DeleteLaboratoryMutation implements Operation{
  final LaboratoryFieldsBuilder builder;
  final String _name = 'deleteLaboratory';
  ...
  @override
  get name => _name;
  DeleteLaboratoryMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
