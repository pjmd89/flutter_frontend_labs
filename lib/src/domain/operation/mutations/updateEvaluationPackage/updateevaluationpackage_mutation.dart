...
class UpdateEvaluationPackageMutation implements Operation{
  final EvaluationPackageFieldsBuilder builder;
  final String _name = 'updateEvaluationPackage';
  ...
  @override
  get name => _name;
  UpdateEvaluationPackageMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
