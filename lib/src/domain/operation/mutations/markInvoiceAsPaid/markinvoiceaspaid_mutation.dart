...
class MarkInvoiceAsPaidMutation implements Operation{
  final InvoiceFieldsBuilder builder;
  final String _name = 'markInvoiceAsPaid';
  ...
  @override
  get name => _name;
  MarkInvoiceAsPaidMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
