...
class UpdateExamMutation implements Operation{
  final ExamFieldsBuilder builder;
  final String _name = 'updateExam';
  ...
  @override
  get name => _name;
  UpdateExamMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
