...
class CancelInvoicePaymentMutation implements Operation{
  final InvoiceFieldsBuilder builder;
  final String _name = 'cancelInvoicePayment';
  ...
  @override
  get name => _name;
  CancelInvoicePaymentMutation({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  Invoice result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return Invoice.fromJson(data[name]);
  }
