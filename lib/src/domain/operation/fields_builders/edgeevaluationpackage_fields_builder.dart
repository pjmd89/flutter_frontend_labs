...
import 'main.dart';
class EdgeEvaluationPackageFieldsBuilder {
  final List<String> _fields = [];
  EdgeEvaluationPackageFieldsBuilder edges({String? alias, Map<String, dynamic>? args, List<Directive>? directives, void Function(EvaluationPackageFieldsBuilder)? builder}) {
  ...
  EdgeEvaluationPackageFieldsBuilder pageInfo({String? alias, Map<String, dynamic>? args, List<Directive>? directives, void Function(PageInfoFieldsBuilder)? builder}) {
