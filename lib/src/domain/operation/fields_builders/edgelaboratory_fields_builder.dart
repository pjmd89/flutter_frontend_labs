...
import 'main.dart';
class EdgeLaboratoryFieldsBuilder {
  final List<String> _fields = [];
  EdgeLaboratoryFieldsBuilder edges({String? alias, Map<String, dynamic>? args, List<Directive>? directives, void Function(LaboratoryFieldsBuilder)? builder}) {
  ...
  EdgeLaboratoryFieldsBuilder pageInfo({String? alias, Map<String, dynamic>? args, List<Directive>? directives, void Function(PageInfoFieldsBuilder)? builder}) {
