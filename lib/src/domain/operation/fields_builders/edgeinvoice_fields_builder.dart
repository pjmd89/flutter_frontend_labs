...
import 'main.dart';
class EdgeInvoiceFieldsBuilder {
  final List<String> _fields = [];
  EdgeInvoiceFieldsBuilder edges({String? alias, Map<String, dynamic>? args, List<Directive>? directives, void Function(InvoiceFieldsBuilder)? builder}) {
  ...
  EdgeInvoiceFieldsBuilder pageInfo({String? alias, Map<String, dynamic>? args, List<Directive>? directives, void Function(PageInfoFieldsBuilder)? builder}) {
