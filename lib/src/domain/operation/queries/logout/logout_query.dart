...
class LogoutQuery implements Operation{
  final UserFieldsBuilder builder;
  final String _name = 'logout';
  ...
  @override
  get name => _name;
  LogoutQuery({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
