import 'package:labs/src/domain/operation/fields_builders/edgetypeaccess_fields_builder.dart';
import '/src/domain/entities/main.dart';
import 'package:agile_front/infraestructure/operation.dart';
import 'package:agile_front/infraestructure/graphql/helpers.dart';
class GetAccessQuery implements Operation{
  final EdgeTypeAccessFieldsBuilder builder;
  final String _name = 'getAccess';
  ...
  @override
  get name => _name;
  GetAccessQuery({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  EdgeTypeAccess result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return EdgeTypeAccess.fromJson(data[name]);
  }
