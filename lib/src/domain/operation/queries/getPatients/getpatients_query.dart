...
class GetPatientsQuery implements Operation{
  final EdgePatientFieldsBuilder builder;
  final String _name = 'getPatients';
  ...
  @override
  get name => _name;
  GetPatientsQuery({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  EdgePatient result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return EdgePatient.fromJson(data[name]);
  }
