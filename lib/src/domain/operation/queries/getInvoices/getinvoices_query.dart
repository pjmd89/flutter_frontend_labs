...
class GetInvoicesQuery implements Operation{
  final EdgeInvoiceFieldsBuilder builder;
  final String _name = 'getInvoices';
  ...
  @override
  get name => _name;
  GetInvoicesQuery({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  EdgeInvoice result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return EdgeInvoice.fromJson(data[name]);
  }
