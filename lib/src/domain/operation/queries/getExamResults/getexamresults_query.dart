...
class GetExamResultsQuery implements Operation{
  final EdgeEvaluationPackageFieldsBuilder builder;
  final String _name = 'getExamResults';
  ...
  @override
  get name => _name;
  GetExamResultsQuery({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  EdgeEvaluationPackage result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return EdgeEvaluationPackage.fromJson(data[name]);
  }
