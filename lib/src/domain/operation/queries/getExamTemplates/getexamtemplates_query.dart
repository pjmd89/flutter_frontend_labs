...
class GetExamTemplatesQuery implements Operation{
  final EdgeExamTemplateFieldsBuilder builder;
  final String _name = 'getExamTemplates';
  ...
  @override
  get name => _name;
  GetExamTemplatesQuery({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  EdgeExamTemplate result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return EdgeExamTemplate.fromJson(data[name]);
  }
