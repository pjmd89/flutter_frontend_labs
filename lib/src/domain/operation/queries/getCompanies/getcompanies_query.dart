...
class GetCompaniesQuery implements Operation{
  final EdgeCompanyFieldsBuilder builder;
  final String _name = 'getCompanies';
  ...
  @override
  get name => _name;
  GetCompaniesQuery({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  EdgeCompany result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return EdgeCompany.fromJson(data[name]);
  }
