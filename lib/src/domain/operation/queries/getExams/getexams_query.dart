...
class GetExamsQuery implements Operation{
  final EdgeExamFieldsBuilder builder;
  final String _name = 'getExams';
  ...
  @override
  get name => _name;
  GetExamsQuery({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  EdgeExam result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return EdgeExam.fromJson(data[name]);
  }
