...
class SystemInfoQuery implements Operation{
  final SystemInfoFieldsBuilder builder;
  final String _name = 'systemInfo';
  ...
  @override
  get name => _name;
  SystemInfoQuery({required this.builder, this.declarativeArgs, this.alias, this.opArgs, this.directives});
  @override
  ...
  @override
  SystemInfo result(Map<String, dynamic> data) {
    String name;
    name = alias ?? _name;
    return SystemInfo.fromJson(data[name]);
  }
